...
function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs uppercase tracking-[0.2em] text-slate-300">Executive Performance Command Center</p>
              </div>
            </div>
      ...
      <main className="mx-auto w-full max-w-7xl px-4 py-6 md:px-6 lg:px-8">{renderContent()}</main>
      ...
      <footer className="mt-8 border-t border-slate-800 bg-slate-900/80">
        <div className="mx-auto w-full max-w-7xl px-4 py-4 text-center text-sm text-slate-300 md:px-6 lg:px-8">
          Built for TICE by Matthew Amaro | Operations Intelligence Prototype
        </div>
      </footer>
    </div>
  )
